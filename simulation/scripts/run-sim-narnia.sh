...
./ows.sh Narnia-0 Narnia.defaults months=1200 year=2017 output=../simulation/output-sim \
    INITIAL_POPULATION_SIZE=$POPULATION_SIZE

./ows.sh Narnia-1 Narnia.defaults months=1200 year=2017 output=../simulation/output-sim \
    INITIAL_POPULATION_SIZE=$POPULATION_SIZE \
    MIGRATION_INFLOW_BASE_PCT=0.5 \
    MIGRATION_OUTFLOW_BASE_PCT=0.5

./ows.sh Narnia-2 Narnia.defaults months=1200 year=2017 output=../simulation/output-sim \
    INITIAL_POPULATION_SIZE=$POPULATION_SIZE \
    MIGRATION_INFLOW_BASE_PCT=1   \
    MIGRATION_OUTFLOW_BASE_PCT=0.5
